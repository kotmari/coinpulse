...
export const PERIOD_CONFIG: Record<
  ...
  {
    days: number | string
    endpoint: "ohlc" | "market_chart"
  }
> = {
  daily:   { days: 1, endpoint: "ohlc" },
  weekly:  { days: 7, endpoint: "ohlc" },
  monthly: { days: 30, endpoint: "ohlc" },

  "3months": { days: 90, endpoint: "market_chart" },
  "6months": { days: 180, endpoint: "market_chart" },
  yearly:    { days: 365, endpoint: "market_chart" },
};
